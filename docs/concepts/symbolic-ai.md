...
!!! example "Hands on: When are symbolic systems appropriate?"
...
!!! example "Hands on: Run a small logic program using Clingo"
...
!!! example "Hands on: Experiencing a rule-based system in practice"
...
!!! example "Hands on: Exploring a formal taxonomy in practice"
    ...
    **Goal:** Observe how a professional classification system organizes knowledge hierarchically.
    ...
    <figure class="course-figure">
        <img class="course-figure-img full-img"
            src="/ai-literacy/assets/images/acm-ccs-ai.png"
...
!!! example "Hands on: Exploring an ontology with Schema.org"
...
<div class="figure-row">
  ...
  <figure class="course-figure">
    <img class="course-figure-img full-img"
         src="/ai-literacy/assets/images/toulmin_model.png"
