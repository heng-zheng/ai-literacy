...
:::{.callout-tip title="Hands on: When past views shape what you see next"}
...
:::{.callout-tip title="Hands on: Tracing visibility in your own feed"}
...
:::{.callout-tip title="Hands on: How platforms explain moderation"}
...
:::{.callout-tip title="Hands on: Seeing detection and intervention in practice"}
...
:::{.callout-tip title="Hands on: Seeing synthetic media in everyday platforms"}
...
:::{.callout-tip title="Hands on: Finding AI use policies in scholarly publishing"}
