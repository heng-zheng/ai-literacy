...
:::{.callout-tip title="Hands on: Experiment with Google Teachable Machine"}
...
:::{.callout-tip title="Hands on: Choosing the appropriate learning paradigm"}
...
:::{.callout-tip title="Hands on: Experiment with TensorFlow Playground"}
