# Content: Machine Learning in Information Contexts
...
:::{.callout-tip title="Hands on: Exploring Face Detection"}
...
:::{.callout-tip title="Hands on: Visual Recognition with Google Images"}
...
:::{.callout-tip title="Hands on: Exploring Named Entity Recognition"}
...
:::{.callout-tip title="Hands on: Exploring Statistical Word Associations"}
...
:::{.callout-tip title="Hands on: Exploring Multiple NLP Tasks"}
...
:::{.callout-tip title="Hands on: Exploring Corpus Patterns with Voyant"}
...
:::{.callout-tip title="Hands on: Exploring Historical Trends with HathiTrust"}
