...
:::{.callout-tip title="Hands-on: Comparing simple prompts"}
...
:::{.callout-tip title="Hands-on: Building a prompt step by step"}
...
:::{.callout-tip title="Hands-on: Comparing zero-shot and few-shot prompting"}
...
:::{.callout-tip title="Hands-on: Trying different prompting strategies"}
...
:::{.callout-tip title="Hands-on: Revising a weak prompt"}
...
:::{.callout-tip title="Hands-on: Checking whether AI-provided links point to the right source"}
...
:::{.callout-tip title="Hands-on: Creating a short AI literacy article about AI hallucination"}
