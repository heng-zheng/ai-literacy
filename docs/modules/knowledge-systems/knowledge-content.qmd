...
:::{.callout-tip title="Hands on: From Raw Document to a Searchable Object"}
...
:::{.callout-tip title="Hands-on: Assisted Description with a Fixed Prompt"}
...
:::{.callout-tip title="Hands-on: Mapping AI in an Information System"}
...
:::{.callout-tip title="Hands-on: Defining the Role of a Virtual Assistant"}
