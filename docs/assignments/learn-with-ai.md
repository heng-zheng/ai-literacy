...
<figure class="course-figure">
    <img class="course-figure-img full-img"
        src="/ai-literacy/assets/images/claude-learning-style.png"
...
Before preparing your .txt file, refer to [Preparing Your AI Interaction Log](../assignments/log-demo.md) for detailed instructions on how to correctly copy, format, and submit your complete interaction history.
