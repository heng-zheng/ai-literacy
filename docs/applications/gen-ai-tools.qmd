...
:::{.callout-tip title="Hands-on: Trying an enterprise AI workflow with Microsoft Copilot"}
...
:::{.callout-tip title="Hands-on: Using Scite to inspect citation context and Assistant"}
...
:::{.callout-tip title="Hands-on: Exploring NotebookLM"}
...
:::{.callout-tip title="Hands-on: Testing prompt-based image generation"}
...
:::{.callout-tip title="Hands-on: Evaluating an AI-generated search summary"}
...
<figure class="course-figure">
    <img class="course-figure-img full-img"
        src="../assets/images/Google-ai-overview-20260322.png"
...
:::{.callout-tip title="Hands-on: Comparing AI search with standard web search"}
...
<figure class="course-figure">
    <img class="course-figure-img full-img"
        src="../assets/images/perplexity-vs-google-20260322.png"
...
:::{.callout-tip title="Optional hands-on: Exploring an AI coding tool"}
